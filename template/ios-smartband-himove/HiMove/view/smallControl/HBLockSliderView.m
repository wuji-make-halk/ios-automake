...
- (void)setupUI{
    ...
    _thumbImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kSliderH, kSliderH)];//CGRectZero
    _thumbImageView.layer.cornerRadius = 25;
...
- (void)fillForeGroundViewWithPoint:(CGPoint)point{
    CGFloat thunmbW = self.thumbImage ? kSliderH : kThumbW;
    CGPoint p = point;
    //修正
    p.x += thunmbW/2;
    if (p.x > kSliderW) {
