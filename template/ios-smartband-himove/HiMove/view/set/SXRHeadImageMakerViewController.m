//
//  SXRHeadImageMakerViewController.m
//  SXRBand
//
...
@interface SXRHeadImageMakerViewController ()
...
@implementation SXRHeadImageMakerViewController
...
- (void)initView {
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 160, 160)];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(SXRHeadImageMakerDelegate)]) {
